...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _Jobs = __webpack_require__(160);

	var _Jobs2 = _interopRequireDefault(_Jobs);

	var _AddJob = __webpack_require__(162);
	...
	var App = function (_Component) {
	    ...
	    _createClass(App, [{
	        key: 'handleAddJob',
	        value: function handleAddJob(job) {
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(_AddJob2.default, { addJob: this.handleAddJob.bind(this) })
	            );
	        }
	    }]);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _Job = __webpack_require__(161);
	...
	var Jobs = function (_Component) {
	    ...
	    _createClass(Jobs, [{
	        ...
	        value: function getJobs() {
	            ...
	            fetch('http://localhost:3000/api/jobs').then(function (res) {
	                return res.json();
	            }).then(function (data) {
	                _this2.setState({
	                    allJobs: data
	                });
	                console.log(_this2.state.allJobs);
	            }).catch(function (res) {
	                console.log(res);
	            });
	        }
	        ...
	        key: 'deleteJob',
	        value: function deleteJob(job, index) {
	            var _this3 = this;

	            console.log(job._id);
	            fetch('http://localhost:3000/api/jobs/' + job._id, { method: 'DELETE' }).then(function (res) {
	        ...
	        value: function render() {
	            ...
	            var jobItems = this.state.allJobs.map(function (job, i) {
	                return _react2.default.createElement(_Job2.default, { key: i, index: i, job: job, removeJob: _this4.deleteJob.bind(_this4, job, i) });
	            });
	            return _react2.default.createElement(
	                'div',
	                null,
	    ...
	    _createClass(Job, [{
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    "button",
	                    { className: "button", onClick: this.delete.bind(this) },
	                    "delete"
	                )
	            );
	        }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var AddJob = function (_Component) {
	    _inherits(AddJob, _Component);

	    function AddJob(props) {
	        _classCallCheck(this, AddJob);

	        var _this = _possibleConstructorReturn(this, (AddJob.__proto__ || Object.getPrototypeOf(AddJob)).call(this, props));
	        ...
	        value: function handleSubmit(e) {
	            ...
	            if (this.refs.message.value === '') {
	                ...
	                this.setState({
	                    ...
	                    _this2.props.addJob(_this2.state.newJob);
	                });
	            }
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement('input', { className: 'input-element', id: 'job-message', type: 'text', ref: 'message' })
	                    ),
	                    _react2.default.createElement(
	                        'div',
	                        { className: 'input-wrapper' },
	                        ...
	                        _react2.default.createElement('input', { className: 'input-element', id: 'job-time', type: 'text', ref: 'time' })
	                    ),
	                    _react2.default.createElement(
	                        'div',
	                        { className: 'input-wrapper' },
	                        ...
	                        _react2.default.createElement('input', { className: 'input-element', id: 'job-channel', type: 'text', ref: 'channel' })
	                    ),
	                    _react2.default.createElement(
	                        'div',
	                        { className: 'input-wrapper' },
	                        ...
	                        _react2.default.createElement('input', { className: 'input-element', id: 'job-status', type: 'text', ref: 'status' })
	                    ),
	                    _react2.default.createElement(
	                        'div',
	                        { className: 'input-wrapper' },
